# Contributing to ignore-lint-errors

Open source projects like `ignore-lint-errors` live on your words of encouragement and contribution. Please give feedback, report issues, or submit pull requests!
...
1. Fork and clone this repo.
    ...
    ```sh
    git clone git@github.com:<your-github-handle>/ignore-lint-errors.git
    ```

1. Change directory.

    ```sh
    cd ignore-lint-errors
    ```
...
1. [Create a tag](https://github.com/ijlee2/ignore-lint-errors/releases/new) and provide release notes. The tag name should match the workspace root's version (e.g. `0.1.2`).
